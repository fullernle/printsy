...
demo_user =
  User.create!(username: 'demo', email: 'demo@demo.com', password: '123123')

user2 =
  User.create!(username: 'fuller', email: 'ful@ful.com', password: '123123')

user3 =
  User.create!(username: 'john', email: 'john@john.com', password: '123123')

user4 =
  User.create!(username: 'jane', email: 'jane@jane.com', password: '123123')
...
user6 =
  User.create!(username: 'lina', email: 'lina@lina.com', password: '123123')

user7 =
  User.create!(username: 'zachary', email: 'zach@zach.com', password: '123123')
...
p1.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/1.png'),
  filename: '1.png'
)
...
p2.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/2.png'),
  filename: '2.png'
)
...
p3.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/3.png'),
  filename: '3.png'
)
...
p4.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/4.png'),
  filename: '4.png'
)
...
p5.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/5.png'),
  filename: '5.png'
)
...
p6.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/6.png'),
  filename: '6.png'
)
...
p7.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/7.png'),
  filename: '7.png'
)
...
p8.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/8.png'),
  filename: '8.png'
)
...
p9.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/9.png'),
  filename: '9.png'
)
...
p10 =
  Product.create!(
    name: 'DVA Necklace',
    description: 'Love Overwatch and Giant Robots? How about a DVA Necklace?!',
    price: 6.99,
    seller_id: 5
  )
...
p10.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/10.png'),
  filename: '10.png'
)
...
p11.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/11.png'),
  filename: '11.png'
)
...
p12 =
  Product.create!(
    name: 'Poly Hat',
    description:
      "Want a cap that doesn't provide shade, but looks cool? Look no further than this poly hat!",
    price: 9.50,
    seller_id: 6
  )
...
p12.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/12.png'),
  filename: '12.png'
)
...
p13.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/13.png'),
  filename: '13.png'
)
...
p14.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/14.png'),
  filename: '14.png'
)
...
p15.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/15.png'),
  filename: '15.png'
)
...
p16 =
  Product.create!(
    ...
    description:
      'Bored of flipping a normal light switch? Turn that light switch into a steampunk switch!',
    price: 4.20,
    seller_id: 7
  )
...
p16.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/16.png'),
  filename: '16.png'
)
...
p17.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/17.png'),
  filename: '17.png'
)
...
p18.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/18.png'),
  filename: '18.png'
)
...
p19.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/19.png'),
  filename: '19.png'
)
...
p20.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/20.png'),
  filename: '20.png'
)
...
p21.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/21.png'),
  filename: '21.png'
)
...
p22.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/22.png'),
  filename: '22.png'
)
...
p23.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/23.png'),
  filename: '23.png'
)
...
p24.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/24.png'),
  filename: '24.png'
)
...
p25.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/25.png'),
  filename: '25.png'
)
...
p26.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/26.png'),
  filename: '26.png'
)
...
p27.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/27.png'),
  filename: '27.png'
)
...
p28.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/28.png'),
  filename: '28.png'
)
...
p29.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/29.png'),
  filename: '29.png'
)
...
p30.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/30.png'),
  filename: '30.png'
)
...
p31.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/31.png'),
  filename: '31.png'
)
...
p32.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/32.png'),
  filename: '32.png'
)
...
p33.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/33.png'),
  filename: '33.png'
)
...
p34.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/34.png'),
  filename: '34.png'
)
...
p35.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/35.png'),
  filename: '35.png'
)
...
p36.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/36.png'),
  filename: '36.png'
)
...
p37.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/37.png'),
  filename: '37.png'
)
...
p38 =
  Product.create!(
    ...
    description:
      'Tired of your ears hurting? Come print these quick release buckles!',
    price: 3.99,
    seller_id: 8
  )
...
p38.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/38.png'),
  filename: '38.png'
)
...
p39 =
  Product.create!(
    ...
    description:
      'Take hat updo to the next level! Beautiful dragon sculpted hair pin',
    price: 12.99,
    seller_id: 6
  )
...
p39.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/39.png'),
  filename: '39.png'
)
...
p40.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/40.png'),
  filename: '40.png'
)
...
p41.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/41.png'),
  filename: '41.png'
)
...
p42.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/42.png'),
  filename: '42.png'
)
...
p43 =
  Product.create!(
    ...
    description:
      "Need more art for that 'minimalistic' home? Look no further! ",
    price: 39.99,
    seller_id: 5
  )
...
p43.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/43.png'),
  filename: '43.png'
)
...
p44.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/44.png'),
  filename: '44.png'
)
...
p45.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/45.png'),
  filename: '45.png'
)
...
p46 =
  Product.create!(
    ...
    description:
      'Not only can they listen to you, but you can make it look like an old alarm clock!',
    price: 14.99,
    seller_id: 8
  )
...
p46.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/46.png'),
  filename: '46.png'
)
...
p47 =
  Product.create!(
    name: 'Iron Man Mask',
    description:
      "I mean... why wouldn't you want something like this? With the right tools, you can make it open and close automatically!",
    price: 29.99,
    seller_id: 5
  )
...
p47.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/47.png'),
  filename: '47.png'
)
...
p48.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/48.png'),
  filename: '48.png'
)
...
p49 =
  Product.create!(
    ...
    description:
      'Who needs an expensive drill press when you can make a miniature one that uses a dremel tool!',
    price: 14.99,
    seller_id: 7
  )
...
p49.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/49.png'),
  filename: '49.png'
)
...
p50.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/50.png'),
  filename: '50.png'
)
...
p51 =
  Product.create!(
    ...
    description:
      'Dynamic tool holder for your peg wall! Tons of variety for all your tools!',
    price: 10.99,
    seller_id: 4
  )
...
p51.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/51.png'),
  filename: '51.png'
)
...
p52 =
  Product.create!(
    ...
    description:
      'Helping hands to keep your wires still while soldering! Comes in three sizes for a variety of wire diameters.',
    price: 5.99,
    seller_id: 4
  )
...
p52.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/52.png'),
  filename: '52.png'
)
...
p53 =
  Product.create!(
    ...
    description:
      'Tired of hurting your hands trying to tigthen those dang hex screws? Print out some handles for all your sizes and needs!',
    price: 4.99,
    seller_id: 5
  )
...
p53.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/53.png'),
  filename: '53.png'
)
...
p54 =
  Product.create!(
    ...
    description:
      'Finish that cosplay with this awesome arc reactor! LEDs not included.',
    price: 10.99,
    seller_id: 7
  )
...
p54.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/54.png'),
  filename: '54.png'
)
...
p55.photo.attach(
  io: open('https://printsy-dev.s3.us-west-1.amazonaws.com/seed/55.png'),
  filename: '55.png'
)
...
p56 =
  Product.create!(
    name: 'Dr Doom Mask!',
    description:
      'Check out this awesome mask! Dr. Doom from Fantastic Four. DOES NOT INCLUDE CLOAK, just mask.',
    price: 14.99,
    seller_id: 8
  )
...
p56.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/56.png'),
  filename: '56.png'
)
...
p57.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/57.png'),
  filename: '57.png'
)
...
p58 =
  Product.create!(
    ...
    description:
      'Who is it under the mask? Inspired by the blue spirit in Avatar The Last Airbender. Finish your next cosplay now!',
    price: 9.99,
    seller_id: 3
  )
...
p58.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/58.png'),
  filename: '58.png'
)
...
p59.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/59.png'),
  filename: '59.png'
)
...
p60.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/60.png'),
  filename: '60.png'
)
...
p61 =
  Product.create!(
    ...
    description:
      'Nightmare before Christmas, but on your ears! Take the iconic character and embrace him!',
    price: 8.99,
    seller_id: 5
  )
...
p61.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/61.png'),
  filename: '61.png'
)
...
p62 =
  Product.create!(
    ...
    description:
      'Take these beautiful pieces of art and rock them on the daily!',
    price: 7.99,
    seller_id: 2
  )
...
p62.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/62.png'),
  filename: '62.png'
)
...
p63 =
  Product.create!(
    ...
    description:
      'Take a piece of culture with you everyday! Moon cake earrings :D',
    price: 8.99,
    seller_id: 3
  )
...
p63.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/63.png'),
  filename: '63.png'
)
...
p64.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/64.png'),
  filename: '64.png'
)
...
p65 =
  Product.create!(
    name: "Majora's Mask",
    description:
      'Become the next skull kid! Take this iconic mask and become the best cosplay of the party!',
    price: 39.99,
    seller_id: 8
  )
...
p65.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/65.png'),
  filename: '65.png'
)
...
p66.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/66.png'),
  filename: '66.png'
)
...
p67.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/67.png'),
  filename: '67.png'
)
...
p68 =
  Product.create!(
    ...
    description:
      'Store random things in this awesome pokeball! Button works! Just need to buy spring.',
    price: 8.99,
    seller_id: 5
  )
...
p68.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/68.png'),
  filename: '68.png'
)
...
p69 =
  Product.create!(
    ...
    description:
      'Bring back those childhood memories with this awesome collapsable print in place lightsaber',
    price: 6.99,
    seller_id: 3
  )
...
p69.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/69.png'),
  filename: '69.png'
)
...
p70 =
  Product.create!(
    ...
    description:
      'Step up those D&D games with this awesome dice tower! DOES NOT COME PRE PAINTED.',
    price: 8.99,
    seller_id: 3
  )
...
p70.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/70.png'),
  filename: '70.png'
)
...
p71.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/71.png'),
  filename: '71.png'
)
...
p72 =
  Product.create!(
    ...
    description:
      'Show up your friends with this awesome 3d printed deck box! Fits commander decks!',
    price: 8.99,
    seller_id: 6
  )
...
p72.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/72.png'),
  filename: '72.png'
)
...
p73.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/73.png'),
  filename: '73.png'
)
...
p74 =
  Product.create!(
    ...
    description:
      'DOES NOT COME WITH HARDWARE. Print out this awesome custom nerf blaster!',
    price: 29.99,
    seller_id: 7
  )
...
p74.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/74.png'),
  filename: '74.png'
)
...
p75 =
  Product.create!(
    ...
    description:
      'DOES NOT COME WITH HARDWARE. Print out this awesome custom nerf blaster! Lever action version!',
    price: 29.99,
    seller_id: 7
  )
...
p75.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/75.png'),
  filename: '75.png'
)
...
p76 =
  Product.create!(
    ...
    description:
      'DOES NOT COME WITH HARDWARE. Print out this awesome nerf blaster! Mag Version!',
    price: 29.99,
    seller_id: 7
  )
...
p76.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/76.png'),
  filename: '76.png'
)
...
p77 =
  Product.create!(
    ...
    description:
      'DOES NOT COME WITH HARDWARE. Print out this awesome nerf blaster! Mini Version!',
    price: 29.99,
    seller_id: 7
  )
...
p77.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/77.png'),
  filename: '77.png'
)
...
p78 =
  Product.create!(
    ...
    description:
      'DOES NOT COME WITH HARDWARE. Print out this awesome nerf blaster! SMG Version!',
    price: 10.99,
    seller_id: 7
  )
...
p78.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/78.png'),
  filename: '78.png'
)
...
p79.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/79.png'),
  filename: '79.png'
)
...
p80 =
  Product.create!(
    ...
    description:
      'Awesome bottle opener that also doubles as a little blaster! Rubberband not included!',
    price: 5.99,
    seller_id: 5
  )
...
p80.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/80.png'),
  filename: '80.png'
)
...
p81.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/81.png'),
  filename: '81.png'
)
...
p82.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/82.png'),
  filename: '82.png'
)
...
p83 =
  Product.create!(
    ...
    description:
      'For all the cat lovers! Great heart sculpt, ideal for any modern aesthetic',
    price: 12.99,
    seller_id: 6
  )
...
p83.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/83.png'),
  filename: '83.png'
)
...
p84.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/84.png'),
  filename: '84.png'
)
...
p85.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/85.png'),
  filename: '85.png'
)
...
p86.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/86.png'),
  filename: '86.png'
)
...
p87.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/87.png'),
  filename: '87.png'
)
...
p88.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/88.png'),
  filename: '88.png'
)
...
p89.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/89.png'),
  filename: '89.png'
)
...
p90.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/90.png'),
  filename: '90.png'
)
...
p91.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/91.png'),
  filename: '91.png'
)
...
p92.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/92.png'),
  filename: '92.png'
)
...
p93.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/93.png'),
  filename: '93.png'
)
...
p94.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/94.png'),
  filename: '94.png'
)
...
p95.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/95.png'),
  filename: '95.png'
)
...
p96.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/96.png'),
  filename: '96.png'
)
...
p97.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/97.png'),
  filename: '97.png'
)
...
p98.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/98.png'),
  filename: '98.png'
)
...
p99.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/99.png'),
  filename: '99.png'
)
...
p100.photo.attach(
  io: open('https://printsy-dev.s3-us-west-1.amazonaws.com/seed/100.png'),
  filename: '100.png'
)
